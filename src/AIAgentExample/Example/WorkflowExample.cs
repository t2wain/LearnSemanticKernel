...
namespace AIAgentExample.Example
{
    public static class WorkflowExample
    {
        ...
        public static Workflow BuildWorkflow2(string emailContent)
        {
            IChatClient chatClient = GetChatClient();
        ...
        public static async Task<object?> RunWorkflow(string emailContent)
        {
        ...
        {
            await RunWorkflow("Congratulations! You've won $1,000,000! Click here to claim your prize now!");
            await RunWorkflow("This is not a spam email");
            return null;
        }
    }
}
